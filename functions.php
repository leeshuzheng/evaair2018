...
register_post_type('visitor_count', // Register Custom Post Type
 array(
	 'labels' => array(
	'name' => __('Visitor Counts', 'hpb'), // Rename these to suit
	'singular_name' => __('Visitor Count', 'hpb'),
	'add_new' => __('Add New', 'hpb'),
	'add_new_item' => __('Add New Visitor Count', 'hpb'),
	'edit' => __('Edit', 'hpb'),
	'edit_item' => __('Edit Visitor Count', 'hpb'),
	'new_item' => __('New Visitor Count', 'hpb'),
	'view' => __('View Visitor Count', 'hpb'),
	'view_item' => __('View Visitor Count', 'hpb'),
	'search_items' => __('Search Visitor Count', 'hpb'),
	'not_found' => __('No Visitor Count found', 'hpb'),
	'not_found_in_trash' => __('No Visitor Counts found in Trash', 'hpb')
),
	 'public' => true,
...
register_post_type('user_submissions', // Register Custom Post Type
 array(
	 'labels' => array(
	'name' => __('User Submissions', 'evaair2018'), // Rename these to suit
	'singular_name' => __('User Submissions', 'evaair2018'),
	'add_new' => __('Add New', 'evaair2018'),
	'add_new_item' => __('Add New User Submission', 'evaair2018'),
	'edit' => __('Edit', 'evaair2018'),
	'edit_item' => __('Edit User Submissions', 'evaair2018'),
	'new_item' => __('New User Submission', 'evaair2018'),
	'view' => __('View User Submissions', 'evaair2018'),
	'view_item' => __('View User Submissions', 'evaair2018'),
	'search_items' => __('Search User Submissions', 'evaair2018'),
	'not_found' => __('No User Submissions found', 'evaair2018'),
	'not_found_in_trash' => __('No User Submissions found in Trash', 'evaair2018')
),
	 'public' => true,
 'hierarchical' => true, // Allows your posts to behave like Hierarchy Pages
 'has_archive' => false,
